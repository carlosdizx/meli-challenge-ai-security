...
model = joblib.load(Path(__file__).parent.parent / 'model/isolation_forest_model.pkl')
...
def analyze(logs: list[LogEntry]):
    ...
    features = df_logs[['Country', 'Region', 'City', 'Device Type', 'Is Attack IP', 'Is Account Takeover']]
